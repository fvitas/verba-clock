...
| SR | Serbian (custom) | Cyrillic / DINish | `src/clock/languages/sr.ts` | verified (native speaker) | 18 phrase cases + grid integrity; our own matrix (D4b), user-approved 2026-08-16 (ПЕТНАЕСТ, no САТИ, ПОЛА = next hour, САД⋅ЈЕ⋅ПОЛА all separated, neutral fillers) |
