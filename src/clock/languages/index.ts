...
export const LANGUAGES: LanguageDef[] = [english, german, germanD2, swissGerman, french, italian, spanish, catalan, dutch, danish, norwegian, swedish, czech, romanian, portuguese, turkish];
